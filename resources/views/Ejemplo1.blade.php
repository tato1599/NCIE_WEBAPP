    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full"> Esto es un ejemplo  </p>
        ...
        <!--Right Col-->
        <div class="w-full md:w-3/5 py-6 text-center rounded-xl">
          <img class="w-full md:w-4/5 z-50 rounded-xl " src="https://scontent.fcjs1-2.fna.fbcdn.net/v/t39.30808-6/333042008_942025953829769_5277167006096817747_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=0debeb&_nc_eui2=AeHWtakD1qDvUnJAZ4w4NfL_MUAEB1sQWscxQAQHWxBaxxCaJPpuACRo8OtupLug5ivLaDeOKWwP4PEOjhaLcncl&_nc_ohc=ceMNwkMNkdYAX8gZDAQ&_nc_ht=scontent.fcjs1-2.fna&oh=00_AfBWfAn1ZkPzwi3J385tQUctqrLqrvNjDNgBr-PsAt64Mg&oe=6401EA4A" />
        </div>
      </div>
    </div>
